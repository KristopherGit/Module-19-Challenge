...
st.sidebar.write("Client Account Address:", account.address)
...
# YOUR CODE HERE
st.sidebar.write("Client Account Balance:", (get_balance(w3, account.address)))
...
# YOUR CODE HERE
st.sidebar.write("Candidate's Wage Total:", wage)
